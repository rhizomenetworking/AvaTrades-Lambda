...
function closeWalletIfPossible(wallet) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let avax_id = yield (0, common_1.getAvaxID)(wallet.chain);
        let can_close = true;
...
function closeTradeIfPossible(trade, bids, royalty) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let avax_id = yield (0, common_1.getAvaxID)(trade.wallet.chain);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let bid of closed_bids) {
            if (bid.wallet.chain === chain) {
                let key = (0, common_1.stringFromAddress)(chain, bid.proceeds_address);
...
function exchange(txc, trade, bidder, royalty) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let xchain = (0, common_1.getNetwork)(txc.chain).XChain();
        ...
        let profit_addresss = (0, common_1.getProfitAddress)(txc.chain);
